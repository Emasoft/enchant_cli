...
"""
    ...
    parser.add_argument("--max-chars", type=int, default=config['text_processing']['max_chars_per_chunk'], 
    ...
    parser.add_argument("--model", type=str,
                        help="AI model name (overrides config/preset)")
    
    parser.add_argument("--endpoint", type=str,
                        help="API endpoint URL (overrides config/preset)")
    ...
    parser.add_argument("--double-pass", action="store_true",
