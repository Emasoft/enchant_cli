...
from common_text_utils import (
    ...
    PRESERVE_UNLIMITED, CHINESE_PUNCTUATION, ENGLISH_PUNCTUATION,
    ALL_PUNCTUATION
)
...
class TestTextCleaning:
    ...
    def test_limit_repeated_chars_mixed(self):
        ...
        assert result == "Wow! Numbers: 111 Symbols: ###"
...
class TestHTMLProcessing:
    ...
    def test_replace_block_tags(self):
        ...
        # Various block tags
        html = "<div>Content</div><section>More</section>"
        result = replace_block_tags(html)
        assert "Content\n\n" in result
        assert "More\n\n" in result
