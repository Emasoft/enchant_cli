...
class TestChineseAITranslatorReal:
    ...
    def test_remove_thinking_block_real(self):
        ...
        for input_text, expected in test_cases:
            ...
            if result.strip() == expected.strip():
                print(f"✓ Removed thinking block correctly")
            else:
    ...
    def test_real_wuxia_translation(self):
        ...
        try:
            ...
            checks = [
                ...
                ("dantian" in result.lower() or "elixir field" in result.lower(), "丹田 terminology"),
                ("qi" in result.lower() or "energy" in result.lower(), "真气 terminology"),
            ]
    ...
    def test_real_double_translation(self):
        ...
        try:
            ...
            single_has_chinese = any('\u4e00' <= c <= '\u9fff' for c in single) if single else True
    ...
    def test_translate_file_real(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                # Translate file
                result = translator.translate_file(str(input_file), str(output_file), is_last_chunk=True)
