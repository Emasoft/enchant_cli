...
class TestXMLGeneration(unittest.TestCase):
    ...
    def test_chapter_xhtml_generation(self):
        ...
        self.assertEqual(html.get('xmlns'), 'http://www.w3.org/1999/xhtml')
        self.assertEqual(head.find('title').text, "Chapter 1: Test Chapter")
        self.assertEqual(body.find('h1').text, "Chapter 1: Test Chapter")
    ...
    def test_ncx_generation(self):
        ...
        # Verify structure
        self.assertEqual(len(nav_map), 3)
        first_nav = nav_map[0]
        self.assertEqual(first_nav.get('playOrder'), '1')
