...
echo ""
echo "gh secret set PYPI_API_TOKEN --repo \"${GITHUB_USER}/${REPO_NAME}\" --body \"\$PYPI_API_TOKEN\""
echo "gh secret set OPENROUTER_API_KEY --repo \"${GITHUB_USER}/${REPO_NAME}\" --body \"\$OPENROUTER_API_KEY\""
echo "gh secret set CODECOV_API_TOKEN --repo \"${GITHUB_USER}/${REPO_NAME}\" --body \"\$CODECOV_API_TOKEN\""
echo ""
