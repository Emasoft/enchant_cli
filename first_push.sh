...
echo ""
echo "gh secret set PYPI_API_TOKEN -b\"\$PYPI_API_TOKEN\" --repo \"${GITHUB_USER}/${REPO_NAME}\""
echo "gh secret set OPENROUTER_API_KEY -b\"\$OPENROUTER_API_KEY\" --repo \"${GITHUB_USER}/${REPO_NAME}\""
echo "gh secret set CODECOV_API_TOKEN -b\"\$CODECOV_API_TOKEN\" --repo \"${GITHUB_USER}/${REPO_NAME}\""
echo ""
