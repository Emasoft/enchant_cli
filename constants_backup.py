...
# -*- coding: utf-8 -*-
"""
Backup of all constants from translation_service.py
These will be used as defaults when generating YAML configuration
"""
...
# Retry settings (from tenacity decorator)
MAX_RETRIES = 7  # Reduced from 77 to 7 attempts
RETRY_WAIT_BASE = 1.0  # Base wait time (multiplier=1 in exponential backoff)
RETRY_WAIT_MIN = 3.0   # Minimum wait time between retries
RETRY_WAIT_MAX = 60.0  # Maximum wait time between retries

# Temperature and max tokens
DEFAULT_TEMPERATURE = 0.05
DEFAULT_MAX_TOKENS = 4000  # Not explicitly set in code but should be configurable
...
# Double pass settings (inferred from code logic)
DOUBLE_PASS_LOCAL = False  # Local API typically doesn't use double pass
DOUBLE_PASS_REMOTE = True  # Remote API typically uses double pass