...
class EnhancedTocBuilder:
    ...
    def build_ncx_toc(self, chapters: List[Tuple[str, str]], 
                      title: str, author: str, uid: str) -> str:
...
def build_enhanced_toc_ncx(chapters: List[Tuple[str, str]], 
                          title: str, author: str, uid: str,
                          hierarchical: bool = True) -> str:
    """
