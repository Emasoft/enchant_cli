...
MODEL_NAME_QWEN = "qwen2.5-14b-instruct-1m@?"
MODEL_NAME_QWEN_OR = 'qwen/qwen-2.5-32b-instruct:nitro'

SYSTEM_PROMPT_QWEN = """You are a professional, authentic machine translation engine.
...
[CHINESE INPUT TEXT TO TRANSLATE]
"""
...
#            "top_k": 0,
    ...
    def translate(self, input_string: str, is_last_chunk=False) -> str:
        ...
        try:
            ...
            english_text = self.translate_chunk(chinese_text, double_translation=True, is_last_chunk=is_last_chunk)
